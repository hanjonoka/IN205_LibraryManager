      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><%= request.getAttribute("nb_membres") %></h3> <!-- TODO : afficher le nombre de membres à la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3><%= request.getAttribute("nb_livres") %></h3> <!-- TODO : afficher le nombre de livres à la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><%= request.getAttribute("nb_emprunts") %></h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
        ...
        <div class="container">
	        <div class="col s12">
	          ...
	          <table class="striped">
                ...
                <tbody id="results">
	                <c:forEach items="${emprunts_current}" var="emprunt">
                    <tr>
                        <td><c:out value="${ emprunt.getLivre().getTitre() }" />, <em>de <c:out value="${ emprunt.getLivre().getAuteur() }" /></em></td>
